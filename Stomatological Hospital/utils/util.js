...
function dateLater(dates, later) {
  ...
  let day = date.getDay();
  dateObj.dates = ((date.getMonth() + 1) < 10 ? ((date.getMonth() + 1)) : date.getMonth() + 1) + "月" + (date.getDate() < 10 ? (date.getDate()) : date.getDate()) + "日";
  dateObj.newdates = ((date.getMonth() + 1) < 10 ? ((date.getMonth() + 1)) : date.getMonth() + 1) + "-" + (date.getDate() < 10 ? (date.getDate()) : date.getDate());
